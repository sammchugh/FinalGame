...
public class Newspaper extends Item {
	...
	public void read(){
		...
		if(Game.getItemInventory("newspaper") == null){
	        ...
	        Game.print("The newspapers says: In order to escape you will need to say 'escape' in the basement holding the toy, candle, and cipher. Make sure you light the candle.");
	     }
